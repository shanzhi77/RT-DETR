...
# 在 attention.py 中修改导入语句
try:
    from ..backbone.TransNext import AggregatedAttention, get_relative_position_cpb
except ImportError:
    # 提供一个替代方案或者抛出更明确的错误信息
    print("TransNext module not found. Please ensure the file exists in the correct location.")
    # 或者使用替代实现
    # from ..backbone.alternative import AggregatedAttention, get_relative_position_cpb
