...
__all__ = ['Ghost_HGBlock', 'Rep_HGBlock', 'DWRC3', 'C3_DWR', 'C2f_DWR', 'BasicBlock_Ortho', 'BottleNeck_Ortho',
           ...
           'ParallelAtrousConv', 'AttentionUpsample', 'AttentionDownsample', 'CSP_PAC', 'DGCST', 'DGSTM', 'RetBlockC3', 'C3_RetBlock', 'C2f_RetBlock',
           ...
           'SRFD', 'DRFD', 'CFC_CRB', 'SFC_G2', 'CAFM', 'CGAFusion', 'CAFMFusion', 'ReduFastNet', 'C3_Faster_CGLU', 'C2f_Faster_CGLU', 'BasicBlock_Faster_Block_CGLU', 'BottleNeck_Faster_Block_CGLU',
           ...
           'DynamicInterpolationFusion', 'FuseBlockMulti'
           ]
...
class ReduFastNet(nn.Module):
    def __init__(self, c1, c2, n=1, scale=0.5, e=0.5):
        super(ReduFastNet, self).__init__()
